    ...
    return (
        <div id="education" class="bg-[#
            ...
            <div class="flex justify-center">
                <h3 class="border-4 w-25  border-dashed px-4 text-md font-bold py-2">Education</h3>
            </div>
            
            <details class="px-6 py-4">
            <summary class="font-bold text-2xl text-gray-800">Seventh Day Adventist High School</summary>
            ...
            <summary class="font-bold text-2xl text-gray-800">BlueCrest University College</summary>
                ...
                <details class="px-6 py-4">
            <summary class="font-bold text-2xl text-gray-800">Gbowee Peace Foundation Africa</summary>
                  <p>Epcot is a theme park at Walt Disney World Resort featuring exciting attractions, international
                    pavilions, award-winning fireworks and seasonal special events.</p>
                </details>
